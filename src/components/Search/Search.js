...
import { ClearIcon, LoadIcon } from '~/static/icons/icon';
import styles from './Search.module.scss';
import React from 'react';
import { useDebounce } from '~/static/hooks';
import axios from 'axios';
import * as instance from '~/static/utils/httpRequest';
import * as searchService from '~/static/services/searchService/searchService';
    ...
    useEffect(() => {
        if (!debounceValue.trim()) {
            ...
            const fetchApi = async () => {
                try {
                    const res = await searchService.searchApi(debounceValue);
                    if (resultRef.current) {
